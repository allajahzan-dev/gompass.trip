...
import { useStories } from "@/lib/graphql/hooks";
import Loader from "@/app/components/animations/Loader";

// Stories section with GraphQL
export default function StoriesSectionGraphQL() {
    // Fetch stories using GraphQL hook
    const { stories, loading, error } = useStories();

    if (loading) {
        return (
            <section className="h-auto px-5 py-16 bg-[#f3f3f3] flex items-center justify-center md:px-10 xl:px-24 md:py-24">
        ...
        return (
            <section className="h-auto px-5 py-16 bg-[#f3f3f3] flex items-center justify-center md:px-10 xl:px-24 md:py-24">
                <div className="text-center">
                    <p className="text-red-600 mb-4">Error loading stories</p>
