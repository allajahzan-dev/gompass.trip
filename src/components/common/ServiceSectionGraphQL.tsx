...
import { useServices } from "@/lib/graphql/hooks";
...
// Service section with GraphQL
export default function ServiceSectionGraphQL() {
    // Fetch services using GraphQL hook
    ...
    if (loading) {
        return (
            <section className="min-h-screen px-5 py-16 bg-[#f3f3f3] flex items-center justify-center md:px-10 xl:px-24 md:py-24">
                <Loader>Loading services...</Loader>
            </section>
        );
    }
